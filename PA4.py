...
def python_rand(num_iterations):
    ...
    outFile = open("Pyrand_output.txt", "w")
    ...
    outFile.close()
    print("Successfully stored random numbers in file named: 'Pyrand_output.txt'.")
...
def generate_lcg(num_iterations):
    ...
    outFile.close()
    print("Successfully stored   random numbers in file named: 'lgc_output.txt'.")
